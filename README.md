...
| ---: | ---: | :---: | :---: | :---: |
| 11notes/beszel-agent:0.14.0 | 6MB | 1000:1000 | ✅ | amd64, arm64, armv7 |
  ...
  agent:
    depends_on:
      hub:
        ...
        restart: true
    image: "11notes/beszel-agent:0.14.0"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
*created 20.10.2025, 06:53:01 (CET)*