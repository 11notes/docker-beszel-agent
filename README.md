  ...
  agent:
    depends_on:
      hub:
        ...
        restart: true
    image: "11notes/beszel-agent:0.107.67"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
...
* [0.107.67](https://hub.docker.com/r/11notes/beszel-agent/tags?name=0.107.67)
* [0.107.67-unraid](https://hub.docker.com/r/11notes/beszel-agent/tags?name=0.107.67-unraid)
...
# REGISTRIES ☁️
```
docker pull 11notes/beszel-agent:0.107.67
docker pull ghcr.io/11notes/beszel-agent:0.107.67
docker pull quay.io/11notes/beszel-agent:0.107.67
```
...
*created 18.10.2025, 07:20:55 (CET)*